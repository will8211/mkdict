...
def dt_convert(s):
    ...
    finals = [('o([2-8]*)',    r'o\1r'),   ('o([2-8]*)h',  r'o\1rh'), 
              ('e([2-8]*)ng',  r'i\1ng'),  ('e([2-8]*)k',  r'i\1k'), 
              ('o([2-8]*)a',   r'u\1a'),   ('o([2-8]*)e',  r'u\1e'), 
              ('o([2-8]*)ai',  r'u\1ai'),  ('o([2-8]*)an', r'u\1an'), 
              ('o([2-8]*)ang', r'u\1ang'),
              ('O([2-8]*)',    r'O\1r'),   ('O([2-8]*)h',  r'O\1rh'), 
              ('E([2-8]*)ng',  r'I\1ng'),  ('E([2-8]*)k',  r'I\1k'), 
              ('O([2-8]*)a',   r'U\1a'),   ('O([2-8]*)e',  r'U\1e'), 
              ('O([2-8]*)ai',  r'U\1ai'),  ('O([2-8]*)an', r'U\1an'), 
              ('O([2-8]*)ang', r'U\1ang')]
    ...
    # The tricky 1*-->7
    s = re.sub(r'(^|[-\s\(])([a-zA-Z]*)([aeiouAEIOU])([ⁿmngr]*|gh)-', 
               r'\g<1>\g<2>\g<3>7\g<4>-', s)
